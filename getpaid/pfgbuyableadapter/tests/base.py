...
def setup_product():
    ...
    import getpaid.pfgbuyableadapter
    zcml.load_config('configure.zcml', getpaid.pfgbuyableadapter)
    ...
    ztc.installPackage('getpaid.pfgbuyableadapter')
...
setup_product()
ptc.setupPloneSite(products=['getpaid.pfgbuyableadapter'])
